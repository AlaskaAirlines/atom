...
internal extension NSRegularExpression {
    ...
    static let urlHost: NSRegularExpression = {
        do {
            ...
            fatalError("Error initializing a valid NSRegularExpression instance given provided pattern for URL host validation. Error: \(error).")
        }
    }()
    ...
    static let urlPath: NSRegularExpression = {
        do {
            ...
            fatalError("Error initializing a valid NSRegularExpression instance given provided pattern for URL path validation. Error: \(error).")
        }
    }()
}
