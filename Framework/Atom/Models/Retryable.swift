...
///
/// Each `URLRequest` instance, before being resumed, will be converted to `Retryable`
...
/// are applied where needed. See `AuthenticationPreference` and `Requestable` for more information.
///
